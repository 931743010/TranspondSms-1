...
//    private static final String FROM_PSW = "xx";
    ...
    private static MailInfo creatMail(String toAdd,String title,String content) {
        ...
        mailInfo.setMailServerHost(SendUtil.get_send_util_email(Define.SP_MSG_SEND_UTIL_EMAIL_HOST_KEY));
        mailInfo.setMailServerPort(SendUtil.get_send_util_email(Define.SP_MSG_SEND_UTIL_EMAIL_PORT_KEY));
        mailInfo.setValidate(true);
        mailInfo.ssl(true);
        mailInfo.setUserName(SendUtil.get_send_util_email(Define.SP_MSG_SEND_UTIL_EMAIL_FROMADD_KEY)); // 你的邮箱地址
        mailInfo.setPassword(SendUtil.get_send_util_email(Define.SP_MSG_SEND_UTIL_EMAIL_PSW_KEY));// 您的邮箱密码
        mailInfo.setFromAddress(SendUtil.get_send_util_email(Define.SP_MSG_SEND_UTIL_EMAIL_FROMADD_KEY)); // 发送的邮箱
        mailInfo.setToAddress(SendUtil.get_send_util_email(Define.SP_MSG_SEND_UTIL_EMAIL_TOADD_KEY)); // 发到哪个邮件去
